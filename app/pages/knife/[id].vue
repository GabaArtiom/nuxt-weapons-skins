<template>
  <div class="min-h-screen tactical-grid-bg" style="background-color: var(--color-tactical-dark);">
    ...
    <main class="mx-auto px-4 py-8" style="max-width: 1600px;">
      <div class="mb-6">
        <NuxtLink to="/?tab=knives" class="hover:underline" style="color: var(--color-accent-primary);">&larr; Назад к ножам</NuxtLink>
      </div>

      <h1 class="text-3xl font-bold mb-2 tracking-wide" style="text-transform: uppercase; letter-spacing: 0.05em;">{{ knifeName }}</h1>
      <p class="mb-8" style="color: var(--color-tactical-muted);">Выберите скин для этого ножа</p>
